...
#include<windows.h>
    ...
    int selection;
    printf("\t\t\t\t------------Welcome to the calender application-----------");
    printf("\t\t\t\t\t\t\t\t by - #PSP ");
    printf("\n\n\n\t 1. Display the months in a particular year\n");
    printf("\t 2. Display the particular month in a year\n");
    printf("\t 3. to exit\n");
   jump:
    scanf("%d", &selection);
...
while(selection != 4){
        ...
        else if(selection == 2){ //Else if block
